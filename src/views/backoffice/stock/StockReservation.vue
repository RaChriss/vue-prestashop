...
<template>
    <div class="container py-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 mb-1 text-black fw-bold">Réservations & Stocks par Catégorie</h1>
                <p class="text-secondary mb-0">Indicateurs de stocks physiques, réservés et disponibles ventilés par
        ...
        <div v-else>
            ...
            <div class="row g-4 mb-5">
                ...
                <div class="col-12 col-md-4">
                    <div class="card stat-card border-0 shadow-sm overflow-hidden h-100 bg-glass-blue">
                        <div class="card-body p-4 position-relative">
                            ...
                            <h2 class="display-6 fw-bold mb-1 text-black">{{ totalPhysique }}</h2>
                            <p class="text-info-light mb-0 fs-7">Quantité totale en stock physique (Réservée +
                                Disponible)</p>
                ...
                <div class="col-12 col-md-4">
                    <div class="card stat-card border-0 shadow-sm overflow-hidden h-100 bg-glass-orange">
                        <div class="card-body p-4 position-relative">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <span class="text-uppercase text-warning fw-bold tracking-wider fs-7">Qté
                                    réservée</span>
                                <div class="icon-circle bg-warning-light text-warning">
                                    <i class="bi bi-bookmark-check fs-4"></i>
                                </div>
                            </div>
                            <h2 class="display-6 fw-bold mb-1 text-black">{{ totalReservee }}</h2>
                            <p class="text-warning-light mb-0 fs-7">Quantité dans les commandes non annulées et non
                                livrées</p>
                ...
                <div class="col-12 col-md-4">
                    <div class="card stat-card border-0 shadow-sm overflow-hidden h-100 bg-glass-green">
                        <div class="card-body p-4 position-relative">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                <span class="text-uppercase text-success fw-bold tracking-wider fs-7">Qté
                                    disponible</span>
                                <div class="icon-circle bg-success-light text-success">
                                    <i class="bi bi-check-circle fs-4"></i>
                                </div>
                            </div>
                            <h2 class="display-6 fw-bold mb-1 text-black">{{ totalDisponible }}</h2>
            ...
            <div class="card border-0 shadow-sm bg-glass-light">
                <div
                    ...
                    <h5 class="mb-0 fw-bold text-black">État des Stocks & Réservations par Catégorie</h5>
                    <span class="badge bg-secondary-light text-secondary rounded-pill px-3">{{ stockReservations.length
                        ...
                        <table class="table table-light table-hover mb-0 align-middle">
                            <thead>
                                <tr class="text-secondary border-bottom border-secondary-light">
                                    ...
                                    <th class="py-3 text-end text-uppercase tracking-wider fs-8 fw-bold">Qté physique
                                    </th>
                                    <th class="py-3 text-end text-uppercase tracking-wider fs-8 fw-bold">Qté réservée
                                    </th>
                                    <th class="px-4 py-3 text-end text-uppercase tracking-wider fs-8 fw-bold">Qté
                                        disponible</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr v-for="res in stockReservations" :key="res.idCategory"
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <span class="fw-semibold text-black">{{ res.categoryName }}</span>
                                        </div>
                                    </td>
                                ...
                                <tr v-if="stockReservations.length === 0">
                                    <td colspan="5" class="text-center py-4 text-secondary fs-6">Aucune catégorie
